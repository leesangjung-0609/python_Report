...
# font=("Malgun Gothic",25,"bold"),bg="#F5EEDC"
# font=("바탕체",30,"bold")
#  font=("Arial", 24, "bold")
...
vs_people = Button(menu_frame,text="1. 1 vs 1", width = 20, height = 2, command=game_start,bg=BTN_COLOR,fg=BTN_FONT_COLOR,font=("Arial",15,"bold"),cursor="hand2",relief="flat") 
vs_AI = Button(menu_frame,text = "2. 1 vs AI", width = 20 , height = 2, command=game_start,bg=BTN_COLOR,fg=BTN_FONT_COLOR,font=("Arial",15,"bold"),cursor="hand2",relief="flat")
game_quit = Button(menu_frame, text = " 3. 그만두기 ", width= 20, height = 2,bg=BTN_COLOR,fg=BTN_FONT_COLOR,font=("Arial",15,"bold"),cursor="hand2",relief="flat")
